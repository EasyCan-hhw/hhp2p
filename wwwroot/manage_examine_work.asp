...
<div id="content"> 
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="####" class="tip-bottom"><i class="icon-th-list"></i> 考勤审批</a></div>
  </div>
  <!--End-breadcrumbs-->
  ...
  <div class="container-fluid">
   ...
   if id<>"" then
     ...
     rs.Open "select * from contracts where wid="&id,conn,1,1
   if not rs.eof then
    %>
    <%
    end if
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <table class="table table-bordered table-striped with-check">
              ...
              -->
                <%
          			err_txt="<tr><td colspan=""12"">没有考勤审批信息</td></tr>"
          			set rs=server.CreateObject("adodb.recordset")
          			rs.Open "select * from monthly_bill where wid>0 order by wid desc",conn,1,1
