...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <%end if%>
    	<%if InStr(request.cookies("hhp2p_cookies")("quanxian"),"[1]")>0 then%>
        <li><a href="javascript:;" id="sidebar_4" class="menu"><i class="icon <%if filename="manage_products" or filename="add_creditor_right" or filename="manage_monthly_bill" or filename="manage_user_bonus_proportion" or filename="manage_jobs_bonus_proportion" or filename="manage_pay_count" or filename="manage_companys_bonus_proportion" or filename="manage_achievement" or filename="manage_PaiXiTiXing"  then%>icon-chevron-up<%else%>icon-chevron-down<%end if%>"></i> <span>财务管理</span></a> 
        	<div class="sidebar" id="menu4" <%if filename="manage_products" or filename="manage_monthly_bill" or filename="manage_user_bonus_proportion" or filename="manage_PaiXiTiXing" or filename="manage_jobs_bonus_proportion" or filename="manage_companys_bonus_proportion" or filename="manage_pay_count" or filename="manage_achievement" or filename="add_creditor_right" then%>style="display:inherit"<%end if%>>
