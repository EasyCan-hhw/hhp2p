...
if action="add" then
	...
	rs("approval")=0
	'response.write "///"&work_tody&"//---"&work_number&"---"&work_name&"---"&work_type&"---"&mwork_time_my&"---"&mwork_start_date&"---"&mwork_end_date&"---"&mwork_cause_txt&"---"&mwork_input_hour
	rs.update
	rs.close
	set rs=nothing
